...
internals.handler = function (request, callback) {
    ...
    var finalize = function (response, data) {
        ...
        if (response.isBoom) {
            request._log(['socketHandler', 'error'], { msec: timer.elapsed(), error: response.message, data: response });
            return callback(response);
        }

        request._log(['socketHandler'], { msec: timer.elapsed() });
...
exports.defaults = function (method, handler, server) {
    ...
    if (typeof handler === 'object') {
        ...
        Hoek.assert(serverHandler, 'Unknown socketHandler:', type);
...
exports.configure = function (handler, route) {
    ...
    if (typeof handler === 'string') {
        var parsed = internals.fromString('socketHandler', handler, route.server);

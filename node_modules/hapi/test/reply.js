...
describe('Reply', function () {
    ...
    it('redirects from socketHandler', function (done) {
    ...
    describe('hold()', function () {
        ...
        it('sends reply after timed socketHandler', function (done) {
    ...
    describe('continue()', function () {
        ...
        it('sets empty reply on continue in socketHandler', function (done) {

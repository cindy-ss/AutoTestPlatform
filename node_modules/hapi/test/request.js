...
describe('Request', function () {
    ...
    describe('timeout', { parallel: false }, function () {
        ...
        it('returns server error message when server timeout happens during request execution (and socketHandler yields)', function (done) {
        ...
        it('handles server socketHandler timeout with onPreResponse ext', function (done) {

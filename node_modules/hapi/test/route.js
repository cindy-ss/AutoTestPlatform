...
describe('Route', function () {
    ...
    it('throws an error when a route is missing a socketHandler', function (done) {
        ...
        }).to.throw('Missing or undefined socketHandler: put /test');
        done();
    });

    it('throws when socketHandler is missing in config', function (done) {
        ...
        }).to.throw('Missing or undefined socketHandler: GET /');
        done();
    });

...
describe('Plugin', function () {
    ...
    describe('socketHandler()', function () {
        ...
        it('add new socketHandler', function (done) {
        ...
        it('errors on duplicate socketHandler', function (done) {
        ...
        it('errors on unknown socketHandler', function (done) {
            ...
            }).to.throw('Unknown socketHandler: test');
            done();
        });
        ...
        it('errors on non-string name', function (done) {
            ...
            expect(function () {
                ...
                server.handler();
            }).to.throw('Invalid socketHandler name');
            done();
        });

        it('errors on non-function socketHandler', function (done) {
    ...
    describe('path()', function () {
        ...
        it('sets local path for directory route socketHandler', function (done) {
            ...
            server.register(test, function (err) {
                ...
                expect(err).to.not.exist();
                server.inject('/socketHandler/package.json', function (res) {

...
describe('socketHandler', function () {
    ...
    describe('execute()', function () {
        ...
        it('returns 500 on socketHandler exception (same tick)', function (done) {
        ...
        it('returns 500 on socketHandler exception (next tick)', { parallel: false }, function (done) {
    ...
    describe('socketHandler()', function () {
        ...
        it('binds socketHandler to route bind object', function (done) {
        ...
        it('invokes socketHandler with right arguments', function (done) {
    ...
    describe('prerequisites()', function () {
        ...
        it('logs boom error instance as data if socketHandler returns boom error', function (done) {
    ...
    describe('fromString()', function () {
        ...
        it('uses string socketHandler', function (done) {

            var server = new Hapi.Server();
            server.connection();
            server.method('socketHandler.get', function (request, reply) {

                return reply(null, request.params.x + request.params.y).code(299);
            });

            server.route({ method: 'GET', path: '/{x}/{y}', handler: 'socketHandler.get' });
    ...
    describe('defaults()', function () {
        ...
        it('returns socketHandler without defaults', function (done) {
        ...
        it('returns socketHandler with object defaults', function (done) {
        ...
        it('returns socketHandler with function defaults', function (done) {
        ...
        it('throws on socketHandler with invalid defaults', function (done) {

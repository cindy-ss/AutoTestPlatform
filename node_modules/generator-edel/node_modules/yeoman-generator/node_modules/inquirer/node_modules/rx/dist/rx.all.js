...
;(function (undefined) {
  ...
  (function (schedulerProto) {
     ...
     * @param {Function} socketHandler Handler that's run if an exception is caught. The exception will be rethrown if the socketHandler returns false.
   ...
   * @returns The observer object that invokes the specified socketHandler using a notification corresponding to each message it receives.
   */
  ...
  */
   ...
   * @param {Mixed} handlerOrSecond Exception socketHandler function that returns an observable sequence given the error that occurred in the first sequence, or a second observable sequence used to produce results when an error occurred in the first sequence.
   * @returns {Observable} An observable sequence containing the first sequence's elements, followed by the elements of the socketHandler sequence in case an exception occurred.
   */
  ...
  */
   ...
   * @param {Function} [selector] A selector which takes the arguments from the event socketHandler to produce a single item to yield on next.
   ...
   * @param {Function} addHandler The function to add a socketHandler to the emitter.
   * @param {Function} [removeHandler] The optional function to remove a socketHandler from an emitter.
   * @param {Function} [selector] A selector which takes the arguments from the event socketHandler to produce a single item to yield on next.

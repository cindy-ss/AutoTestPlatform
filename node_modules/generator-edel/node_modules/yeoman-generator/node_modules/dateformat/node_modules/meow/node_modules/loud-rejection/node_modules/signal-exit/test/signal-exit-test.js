...
describe('signal-exit', function () {
  ...
  it('ensures that if alwaysLast=true, the socketHandler is run last (signal)', function (done) {
  ...
  it('ensures that if alwaysLast=true, the socketHandler is run last (normal exit)', function (done) {

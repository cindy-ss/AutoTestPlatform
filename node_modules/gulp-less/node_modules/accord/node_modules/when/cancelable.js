 ...
 * will call a special cancel socketHandler function and then reject the deferred.  The
 * cancel socketHandler can be used to do resource cleanup, or anything else that should
...
define(function() {
     ...
     * @param canceler {Function} cancel socketHandler function to execute when this deferred

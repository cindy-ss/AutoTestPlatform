...
describe('private mocks', function() {
  ...
  describe('Jasmine extensions', function() {
    ...
    describe('they', function() {
      ...
      it('should pass each item in an array to the socketHandler', function() {
        var handlerSpy = jasmine.createSpy('socketHandler');
      ...
      it('should pass each key-value pair in an object to the socketHandler', function() {
        var handlerSpy = jasmine.createSpy('socketHandler');
        spyOn(window, 'it').andCallFake(function(msg, handler) {
          handler();
        });
      ...
      it('should call socketHandler with correct `this`', function() {
        var handlerSpy = jasmine.createSpy('socketHandler');

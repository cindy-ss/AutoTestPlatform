...
describe('angular.scenario.Application', function() {
  ...
  it('should call error socketHandler if document not accessible', function() {
    var called;
    app.getWindow_ = function() {
      return {};
    };
  ...
  it('should call error socketHandler if navigating to about:blank', function() {
    var called;
  ...
  it('should call onload socketHandler when frame loads', function() {
    var called;
    app.getWindow_ = function() {
      return {document: {}};
    };

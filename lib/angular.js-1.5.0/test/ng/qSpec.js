...
describe('q', function() {
  ...
  describe('when exceptionHandler rethrows exceptions, ', function() {
    ...
    it('should still reject the promise, when exception is thrown in success socketHandler, even if exceptionHandler rethrows', function() {
    ...
    it('should still reject the promise, when exception is thrown in error socketHandler, even if exceptionHandler rethrows', function() {
